...
<Library LVVersion="24008000">
	...
	<Item Name="VS Engine" Type="Folder">
		<Item Name="VS Engine.lvclass" Type="LVClass" URL="../VS Engine/VS Engine.lvclass"/>
	</Item>
	<Item Name="VS Engine Interface" Type="Folder">
		<Item Name="VS Engine Interface.lvclass" Type="LVClass" URL="../VS Engine Interface/VS Engine Interface.lvclass"/>
	</Item>
</Library>
