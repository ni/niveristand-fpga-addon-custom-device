...
| VI  | Description |
|-------|-------------|
| Get RIO Resource <br> ![Get RIO resource](https://github.com/DStavilaNI/niveristand-fpga-addon-custom-device/blob/471e1e8cfc5b3445faa2960cddb6fef43029d860/Source/Quick%20Start%20Documentation/Images/RIO.PNG) | Returns the hardware RIO resource configured for the FPGA addon target.  |
| Get FPGA Bitfile <br> <p>![Get FPGA bitfile](./Images/get_fpga_bitfile.png) </p>| Returns the path of the configured bitfile for the provided FPGA addon. |
